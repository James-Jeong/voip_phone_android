package com.jamesj.voip_phone_android.media.protocol.rtp.attribute.base;
...
/**
 * @class public class Text implements CharSequence
 * @brief Text class
 */
public class Text implements CharSequence {
    ...
    private final byte nine_byte=(byte)'9';
    private final byte a_byte=(byte)'a';
    private final byte f_byte=(byte)'f';
    private final byte A_byte=(byte)'A';
    private final byte F_byte=(byte)'F';
    private final byte minus_byte=(byte)'-';
