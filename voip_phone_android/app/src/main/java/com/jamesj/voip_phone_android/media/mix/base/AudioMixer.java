...
import com.jamesj.voip_phone_android.media.record.RecordManager;
import com.jamesj.voip_phone_android.media.record.wav.WavFileInfo;
...
public class AudioMixer {
    ...
    public AudioMixer(String mixFileName, int samplingRate, int sampleSize, short channelSize) {
        ...
        Logger.d("AudioMixer is created. (mixFileName={}, samplingRate={})",
        ...
        try {
            ...
            if (recvTaskExecutor == null) {
                ...
                try {
                    ...
                    Logger.w("AudioMixer.start.executor.Exception", e);
                    return;
                }

                Logger.d("AudioMixer RecvTask is added.");
            }
            ...
            Logger.w("AudioMixer.start.Exception", e);
        }
    }
    ...
    public void stop () {
        ...
        if (recvTaskExecutor != null) {
            ...
            Logger.d("AudioMixer RecvTask is removed.");
        }
        ...
        if (mixRecordManager != null) {
            ...
            /*try {
                ...
                Logger.w("stop.Files.readAllBytes.Exception", e);
            }*/
        }
    }
    ...
    public int getAudioBufferMapSize () {
        try {
            ...
            Logger.w("AudioMixer.getAudioBufferMapSize.Exception", e);
            return 0;
        } finally {
    ...
    public void addAudioBuffer (String bufferId) {
        try {
            ...
            Logger.w("AudioMixer.addAudioBuffer.Exception", e);
        } finally {
            audioBufferMapLock.unlock();
        }
    }
    ...
    public AudioBuffer getAudioBuffer (String bufferId) {
        try {
            ...
            Logger.w("AudioMixer.getAudioBuffer.Exception", e);
            return null;
        } finally {
            audioBufferMapLock.unlock();
        }
    ...
    public AudioBuffer removeAudioBuffer (String bufferId) {
        try {
            ...
            Logger.w("AudioMixer.removeAudioBuffer.Exception", e);
            return null;
        } finally {
            audioBufferMapLock.unlock();
        }
    ...
    public Map<String, AudioBuffer> getCloneAudioBufferMap() {
        ...
        try {
            ...
            try {
                ...
                Logger.w("Fail to clone the audio buffer map.");
                cloneMap = audioBufferMap;
            }
        } catch (Exception e) {
            Logger.w("AudioMixer.getCloneAudioBufferMap.Exception", e);
            return null;
        } finally {
            audioBufferMapLock.unlock();
        }
    ...
    private class MixTask extends TaskUnit {
        ...
        protected MixTask(int interval) {
            ...
            //Logger.w("MixTask: packetSize={}", PACKET_SIZE);
        }
