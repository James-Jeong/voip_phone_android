...
/**
 * @class public abstract class FourierTransform
 * @brief FourierTransform abstract class
 */
public abstract class FourierTransform {
     ...
     */
    public abstract float[] inverse(float[] buffer);
     ...
     */
    public float[] inverse(float[] freqReal, float[] freqImag, float[] buffer) {
